...
namespace UltraPaste.Core
{
    ...
    internal class UltraPasteCommand
    {
        ...
        internal void UltraPasteInit(Vegas vegas, ref List<CustomCommand> CustomCommands)
        {
            ...
            CustomCommand cmdSubtitlesEditBox = new CustomCommand(CommandCategory.Tools, "0_SubtitlesEditBox") { DisplayName = I18n.Translation.SubtitlesEditBox };
            cmdSubtitlesEditBox.Invoked += delegate (object o, EventArgs e)
            {
                if (!myVegas.ActivateDockView("UltraWindow_SubtitlesEdit"))
                {
                    myVegas.LoadDockView(new UltraWindow_SubtitlesEdit { AutoLoadCommand = cmdSubtitlesEditBox });
                }
            };
            cmdSubtitlesEditBox.MenuPopup += delegate (object o, EventArgs e)
            {
                cmdSubtitlesEditBox.Checked = myVegas.FindDockView("UltraWindow_SubtitlesEdit");
            };
            cmdSubtitlesEditBox.SetIconFile("UltraPaste.png");
            cmdSubtitlesImport.AddChild(cmdSubtitlesEditBox);
            CustomCommands.Add(cmdSubtitlesEditBox);
